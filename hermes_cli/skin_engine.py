...
.. code-block:: yaml
    ...
    branding:
      agent_name: "EVA Agent"             # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "EVA Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "EVA Agent",
            "welcome": "Welcome to EVA Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ EVA ",
            "prompt_symbol": "❯",
